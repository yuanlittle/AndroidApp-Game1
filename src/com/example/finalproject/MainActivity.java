...
public class MainActivity extends Activity {
	...
	public static Activity imain= null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final LatLng cameracenter= new LatLng(35.43,-78.16);
		...
		surrender.setOnClickListener(new OnClickListener(){
        	...
        	private Runnable mLaunchTask1 = new Runnable(){
				...
				public void run(){
	        		...
	        		intent1.setClass(MainActivity.this,StartScreen.class);
	    ...
	    mMap = ((MapFragment) getFragmentManager().findFragmentById(R.id.map))
	            .getMap();
	    CivilWar carCiv = new CivilWar();
	    ArrayList<CivilWar.Locations> myCarLoc = carCiv.setCarolinaLocations();

	    final int size = createMarkers(numLocInt, myCarLoc, mMap);
	   ...
	   mMap.getUiSettings().setAllGesturesEnabled(false);
	    ...
	    mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(cameracenter, (float)6.4));
